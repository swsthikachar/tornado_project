...
# Set up logging
logging.basicConfig(filename='transaction_logs.log', level=logging.INFO, format='%(asctime)s - %(message)s')
    ...
    def post(self):
        ...
        if existing_user is None:
            try:
                ...
                logging.info("Data inserted successfully: %s", data)
            ...
            self.write(
                "<h1 style='color:red; font-weight:bold;'>This email already exists,<a href='signin'>signin</a></h1>")
